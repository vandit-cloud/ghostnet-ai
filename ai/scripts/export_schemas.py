...
DESCRIPTIONS: dict[str, str] = {
    ...
    "Detection.mask": "Optional outline polygon, [[x, y], ...] in pixels, same frame and origin as bbox. Null from the box detector; filled for ghost_net when the net segmentation model runs (contract 1.3.0).",
    "Detection.review_only": "True when this is a review candidate, not a claim. Render distinctly and exclude from detection counts.",
