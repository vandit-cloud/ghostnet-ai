      ...
      <div className="space-y-6">
        ...
        <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
          ...
          <KpiCard
            ...
            tone={data.high_priority > 0 ? "high" : "neutral"}
            hint="Signals likely to need immediate operator review."
          />
          <KpiCard
            label="Pending Review"
            value={data.needs_review}
            tone={data.needs_review > 0 ? "critical" : "neutral"}
            hint="Items still waiting for human confirmation."
          />
          <KpiCard
